...
const char* ei_classifier_inferencing_categories[] = { "cheap", "expensive", "moderate" };

uint8_t ei_dsp_config_5_axes[] = { 0, 1, 2, 3, 4 };
const uint32_t ei_dsp_config_5_axes_size = 5;
...
const uint32_t ei_learning_block_4_inputs[1] = { 5 };
...
const ei_impulse_t impulse_494533_0 = {
    .project_id = 494533,
    .project_owner = "Jean Paul Elisa NIYOKWIZERWA",
    .project_name = "Ndevu-project-1",
    .deploy_version = 1,

    .nn_input_frame_size = 5000,
    .raw_sample_count = 1000,
    .raw_samples_per_frame = 5,
    .dsp_input_frame_size = 1000 * 5,
    .input_width = 0,
    .input_height = 0,
    .input_frames = 0,
    .interval_ms = 1,
    ...
    .fusion_string = "area + bedrooms + bathrooms + stories + parking",
    .slice_size = (1000/4),
...
ei_impulse_handle_t impulse_handle_494533_0 = ei_impulse_handle_t( &impulse_494533_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_494533_0;
